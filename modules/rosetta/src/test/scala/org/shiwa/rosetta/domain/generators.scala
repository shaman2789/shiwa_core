...
import org.shiwa.rosetta.domain.amount._
import org.shiwa.rosetta.domain.api.construction.ConstructionMetadata.MetadataResult
import org.shiwa.rosetta.domain.currency.SHI
...
object generators extends NumericInstances {
  ...
  val positiveAmountGen: Gen[Amount] = for {
    ...
    posAmount = Amount(AmountValue(Refined.unsafeApply[Long, AmountValuePredicate](posLong)), SHI)
  } yield posAmount
