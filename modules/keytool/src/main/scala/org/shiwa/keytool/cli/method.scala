package org.shiwa.keytool.cli

import cats.syntax.contravariantSemigroupal._

import org.shiwa.cli.env._
import org.shiwa.ext.decline.WithOpts
import org.shiwa.keytool.cert.DistinguishedName
...
object method {
  ...
  val distinguishedName = DistinguishedName(
    commonName = "shiwanetwork.io",
    organization = "ShiwaNetwork Labs"
  )
  val certificateValidityDays: Long = 365 * 500 // 500 years of validity should be enough I guess
