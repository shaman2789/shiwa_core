...
import org.shiwa.dag.l1.domain.consensus.block.BlockConsensusInput.{BlockSignatureProposal, CancelledBlockCreationRound, Proposal}
...
import org.shiwa.sdk.domain.transaction.filter.Consecutive
