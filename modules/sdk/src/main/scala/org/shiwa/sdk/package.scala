...
import org.shiwa.sdk.domain.healthcheck.consensus.types.HealthCheckRoundId
import org.shiwa.sdk.infrastructure.consensus.declaration.{Facility, MajoritySignature, Proposal}
import org.shiwa.sdk.infrastructure.consensus.message._
import org.shiwa.sdk.infrastructure.consensus.trigger.{EventTrigger, TimeTrigger}
import org.shiwa.sdk.infrastructure.healthcheck.ping._
import org.shiwa.shared._
