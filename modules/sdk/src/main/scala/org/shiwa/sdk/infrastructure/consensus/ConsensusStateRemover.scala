...
import org.shiwa.sdk.infrastructure.consensus.declaration.kind.{PeerDeclarationKind, _}
import org.shiwa.sdk.infrastructure.consensus.message.ConsensusWithdrawPeerDeclaration
