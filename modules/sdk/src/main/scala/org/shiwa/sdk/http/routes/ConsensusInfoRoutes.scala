...
import org.shiwa.schema.peer.{PeerId, PeerInfo}
import org.shiwa.sdk.domain.cluster.services.Cluster
import org.shiwa.sdk.http.routes.ConsensusInfoRoutes.ConsensusInfo
import org.shiwa.sdk.infrastructure.consensus.{ConsensusOutcome, ConsensusStorage}
